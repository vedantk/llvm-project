...
TEST(CoalescingBitVectorTest, Intersection) {
  ...
  intersectionIs({}, {}, {});
  intersectionIs({1}, {1}, {1});
  intersectionIs({1}, {2}, {});

  // Exact overlaps cases: single overlap and multiple overlaps.
  intersectionIs({1, 2}, {1, 2}, {1, 2});
  intersectionIs({1, 2, 11, 12}, {1, 2, 11, 12}, {1, 2, 11, 12});

  // Sliding window: fix {2, 3, 4} as the LHS, and slide a window before/after
  // it. Repeat this swapping LHS and RHS.
  intersectionIs({2, 3, 4}, {1, 2, 3}, {2, 3});
  intersectionIs({2, 3, 4}, {2, 3, 4}, {2, 3, 4});
  intersectionIs({2, 3, 4}, {3, 4, 5}, {3, 4});
  intersectionIs({1, 2, 3}, {2, 3, 4}, {2, 3});
  intersectionIs({3, 4, 5}, {2, 3, 4}, {3, 4});

  // No overlap, but we have multiple intervals.
  intersectionIs({1, 2, 11, 12}, {3, 4, 13, 14}, {});
  ...
  intersectionIs({1, 2, 11, 12}, {1}, {1});
  intersectionIs({1, 2, 11, 12}, {2}, {2});
  intersectionIs({1, 2, 11, 12}, {11}, {11});
  intersectionIs({1, 2, 11, 12}, {12}, {12});
  intersectionIs({1, 2, 11, 12}, {1, 11}, {1, 11});
  intersectionIs({1, 2, 11, 12}, {1, 12}, {1, 12});
  intersectionIs({1, 2, 11, 12}, {2, 11}, {2, 11});
  intersectionIs({1, 2, 11, 12}, {2, 12}, {2, 12});
  intersectionIs({1, 2, 11, 12}, {1, 2, 11}, {1, 2, 11});
  intersectionIs({1, 2, 11, 12}, {1, 2, 12}, {1, 2, 12});
  intersectionIs({1, 2, 11, 12}, {1, 11, 12}, {1, 11, 12});
  intersectionIs({1, 2, 11, 12}, {2, 11, 12}, {2, 11, 12});
  intersectionIs({1, 2, 11, 12}, {0, 11, 12}, {11, 12});
  intersectionIs({1, 2, 11, 12}, {3, 11, 12}, {11, 12});
  intersectionIs({1, 2, 11, 12}, {1, 11, 13}, {1, 11});
  intersectionIs({1, 2, 11, 12}, {1, 10, 11}, {1, 11});

  // Partial overlap, but the existing interval covers future overlaps.
  intersectionIs({1, 2, 3, 4, 5, 6, 7, 8}, {2, 3, 4, 6, 7}, {2, 3, 4, 6, 7});
}
